...
class cusers extends cTable {
	...
	function __construct() {
		...
		// userID
		$this->_userID = new cField('users', 'users', 'x__userID', 'userID', '`userID`', '`userID`', 3, -1, FALSE, '`userID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->_userID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['userID'] = &$this->_userID;

		// userName
		$this->userName = new cField('users', 'users', 'x_userName', 'userName', '`userName`', '`userName`', 201, -1, FALSE, '`userName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['userName'] = &$this->userName;

		// password
		$this->password = new cField('users', 'users', 'x_password', 'password', '`password`', '`password`', 201, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['password'] = &$this->password;

		// User Level
		$this->User_Level = new cField('users', 'users', 'x_User_Level', 'User Level', '`User Level`', '`User Level`', 3, -1, FALSE, '`User Level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
