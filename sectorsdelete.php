...
// Page object
var sectors_delete = new ew_Page("sectors_delete");
sectors_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = sectors_delete.PageID; // For backward compatibility

// Form object
var fsectorsdelete = new ew_Form("fsectorsdelete");
...
?>
<form name="fsectorsdelete" id="fsectorsdelete" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_sectorsdelete" class="ewTable ewTableSeparate">
<?php echo $sectors->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($sectors->ID->Visible) { // ID ?>
		<td><span id="elh_sectors_ID" class="sectors_ID"><?php echo $sectors->ID->FldCaption() ?></span></td>
<?php } ?>
<?php if ($sectors->Sector->Visible) { // Sector ?>
		<td><span id="elh_sectors_Sector" class="sectors_Sector"><?php echo $sectors->Sector->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $sectors_delete->RowCnt ?>_sectors_ID" class="control-group sectors_ID">
...
<span id="el<?php echo $sectors_delete->RowCnt ?>_sectors_Sector" class="control-group sectors_Sector">
