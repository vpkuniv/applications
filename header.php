...
<?php if (!ew_IsMobile()) { ?>
  ...
  <div id="ewHeaderRow" class="ewHeaderRow"><img src="phpimages/header_new.jpg" alt="" style="border: 0;"></div>
	<!-- header (end) -->
<?php } ?>
<?php if (ew_IsMobile()) { ?>
...
<div class="ewMenuRow">
<?php } else { // modification Supports for Horizontal and Vertical Menu, by Masino Sinaga, April 30, 2012 ?>
    <!-- content (begin) -->
  <table id="ewContentTable" class="ewContentTable">
        <tr>
            <td class="ewMenuColumn">
            <!-- left column (begin) -->
<?php } // modification Supports for Horizontal and Vertical Menu, by Masino Sinaga, April 30, 2012 ?>
<?php include_once "ewmenu.php" ?>
<?php if (MS_MENU_HORIZONTAL) { // modification Supports for Horizontal and Vertical Menu, by Masino Sinaga, April 30, 2012 ?>
</div>
    <!-- content (begin) -->
  <table id="ewContentTable" class="ewContentTable">
        <tr>
