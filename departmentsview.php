...
class cdepartments_view extends cdepartments {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["DID"] <> "") {
			$this->RecKey["DID"] = $_GET["DID"];
			$KeyUrl .= "&amp;DID=" . urlencode($this->RecKey["DID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["DID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["DID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["DID"] <> "") {
				...
				$this->RecKey["DID"] = $this->DID->QueryStringValue;
			} else {
				$sReturnUrl = "departmentslist.php"; // Return to list
			}
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_departments\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_departments',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fdepartmentsview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Page object
var departments_view = new ew_Page("departments_view");
departments_view.PageID = "view"; // Page ID
var EW_PAGE_ID = departments_view.PageID; // For backward compatibility

// Form object
var fdepartmentsview = new ew_Form("fdepartmentsview");
...
fdepartmentsview.ValidateRequired = true;
<?php } else { ?>
fdepartmentsview.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$departments_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fdepartmentsview" id="fdepartmentsview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="departments">
<table class="ewGrid"><tr><td>
<table id="tbl_departmentsview" class="table table-bordered table-striped">
...
<?php echo $departments->DID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($departments->DepartmentName->Visible) { // DepartmentName ?>
	<tr id="r_DepartmentName">
		<td><span id="elh_departments_DepartmentName"><?php echo $departments->DepartmentName->FldCaption() ?></span></td>
...
<?php echo $departments->DepartmentName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($departments->CID->Visible) { // CID ?>
	<tr id="r_CID">
		<td><span id="elh_departments_CID"><?php echo $departments->CID->FldCaption() ?></span></td>
...
<?php echo $departments->CID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($departments->DepartmentName2DAR->Visible) { // DepartmentName-AR ?>
	<tr id="r_DepartmentName2DAR">
		<td><span id="elh_departments_DepartmentName2DAR"><?php echo $departments->DepartmentName2DAR->FldCaption() ?></span></td>
...
<?php echo $departments->DepartmentName2DAR->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
