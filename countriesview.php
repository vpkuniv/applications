...
class ccountries_view extends ccountries {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["NID"] <> "") {
			$this->RecKey["NID"] = $_GET["NID"];
			$KeyUrl .= "&amp;NID=" . urlencode($this->RecKey["NID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["NID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["NID"]);
		}
		$this->CurrentAction = (@$_GET["a"] <> "") ? $_GET["a"] : @$_POST["a_list"]; // Set up current action

		// Setup export options
		$this->SetupExportOptions();
		$this->NID->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["NID"] <> "") {
				...
				$this->RecKey["NID"] = $this->NID->QueryStringValue;
			} else {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_countries\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_countries',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fcountriesview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
<?php if ($countries->NID->Visible) { // NID ?>
	<tr id="r_NID">
		<td><span id="elh_countries_NID"><?php echo $countries->NID->FldCaption() ?></span></td>
		<td<?php echo $countries->NID->CellAttributes() ?>>
<span id="el_countries_NID" class="control-group">
<span<?php echo $countries->NID->ViewAttributes() ?>>
<?php echo $countries->NID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($countries->Nationality->Visible) { // Nationality ?>
	<tr id="r_Nationality">
		<td><span id="elh_countries_Nationality"><?php echo $countries->Nationality->FldCaption() ?></span></td>
		<td<?php echo $countries->Nationality->CellAttributes() ?>>
<span id="el_countries_Nationality" class="control-group">
<span<?php echo $countries->Nationality->ViewAttributes() ?>>
<?php echo $countries->Nationality->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
