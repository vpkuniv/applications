...
$gpa_equivalency_update = NULL; // Initialize page object first

class cgpa_equivalency_update extends cgpa_equivalency {
	...
	// Page object name
	var $PageObjName = 'gpa_equivalency_update';
	...
	function Page_Main() {
		...
		if (count($this->RecKeys) <= 0)
			$this->Page_Terminate("gpa_equivalencylist.php"); // No records selected, return to list
		...
		if ($this->Recordset = $this->LoadRecordset()) {
			...
			while (!$this->Recordset->EOF) {
				if ($i == 1) {
					...
					$this->Civil_ID->setDbValue($this->Recordset->fields('Civil ID'));
					$this->Passport_No2E->setDbValue($this->Recordset->fields('Passport No.'));
					$this->Sector->setDbValue($this->Recordset->fields('Sector'));
					$this->Job_Title->setDbValue($this->Recordset->fields('Job Title'));
					$this->Program->setDbValue($this->Recordset->fields('Program'));
					$this->College->setDbValue($this->Recordset->fields('College'));
					$this->Department->setDbValue($this->Recordset->fields('Department'));
					$this->Bachelors_Title->setDbValue($this->Recordset->fields('Bachelors Title'));
					$this->Bachelor_University->setDbValue($this->Recordset->fields('Bachelor University'));
					$this->Bachelors_Major->setDbValue($this->Recordset->fields('Bachelors Major'));
					$this->Bachelors_GPA->setDbValue($this->Recordset->fields('Bachelors GPA'));
					$this->Bachelors_MGPA->setDbValue($this->Recordset->fields('Bachelors MGPA'));
					$this->Other_Bachelors_Title->setDbValue($this->Recordset->fields('Other Bachelors Title'));
					$this->Other_Bachelors_University->setDbValue($this->Recordset->fields('Other Bachelors University'));
					$this->Other_Bachelors_Major->setDbValue($this->Recordset->fields('Other Bachelors Major'));
					$this->Other_Bachelors_GPA->setDbValue($this->Recordset->fields('Other Bachelors GPA'));
					$this->Other_Bachelors_MGPA->setDbValue($this->Recordset->fields('Other Bachelors MGPA'));
					$this->Masters_Degree_Title->setDbValue($this->Recordset->fields('Masters Degree Title'));
					$this->Master_University->setDbValue($this->Recordset->fields('Master University'));
					$this->Masters_Degree_Major->setDbValue($this->Recordset->fields('Masters Degree Major'));
					$this->Masters_GPA->setDbValue($this->Recordset->fields('Masters GPA'));
					$this->Other_Masters_Degree_Title->setDbValue($this->Recordset->fields('Other Masters Degree Title'));
					$this->Other_Masters_University->setDbValue($this->Recordset->fields('Other Masters University'));
					$this->Other_Masters_Major->setDbValue($this->Recordset->fields('Other Masters Major'));
					$this->Other_Masters_GPA->setDbValue($this->Recordset->fields('Other Masters GPA'));
					$this->PhD_Title->setDbValue($this->Recordset->fields('PhD Title'));
					$this->Phd_University->setDbValue($this->Recordset->fields('Phd University'));
					$this->PhD_Major->setDbValue($this->Recordset->fields('PhD Major'));
					$this->Phd_Degree_Equivalency->setDbValue($this->Recordset->fields('Phd Degree Equivalency'));
					$this->Committee_Meeting->setDbValue($this->Recordset->fields('Committee Meeting'));
					$this->Committee_Meeting_Number->setDbValue($this->Recordset->fields('Committee Meeting Number'));
					$this->Committee_Date->setDbValue($this->Recordset->fields('Committee Date'));
					...
					if (!ew_CompareValue($this->Civil_ID->DbValue, $this->Recordset->fields('Civil ID')))
						$this->Civil_ID->CurrentValue = NULL;
					if (!ew_CompareValue($this->Passport_No2E->DbValue, $this->Recordset->fields('Passport No.')))
					...
					if (!ew_CompareValue($this->Job_Title->DbValue, $this->Recordset->fields('Job Title')))
						$this->Job_Title->CurrentValue = NULL;
					if (!ew_CompareValue($this->Program->DbValue, $this->Recordset->fields('Program')))
						$this->Program->CurrentValue = NULL;
					if (!ew_CompareValue($this->College->DbValue, $this->Recordset->fields('College')))
						$this->College->CurrentValue = NULL;
					if (!ew_CompareValue($this->Department->DbValue, $this->Recordset->fields('Department')))
						$this->Department->CurrentValue = NULL;
					if (!ew_CompareValue($this->Bachelors_Title->DbValue, $this->Recordset->fields('Bachelors Title')))
						$this->Bachelors_Title->CurrentValue = NULL;
					if (!ew_CompareValue($this->Bachelor_University->DbValue, $this->Recordset->fields('Bachelor University')))
						$this->Bachelor_University->CurrentValue = NULL;
					if (!ew_CompareValue($this->Bachelors_Major->DbValue, $this->Recordset->fields('Bachelors Major')))
						$this->Bachelors_Major->CurrentValue = NULL;
					if (!ew_CompareValue($this->Bachelors_GPA->DbValue, $this->Recordset->fields('Bachelors GPA')))
						$this->Bachelors_GPA->CurrentValue = NULL;
					if (!ew_CompareValue($this->Bachelors_MGPA->DbValue, $this->Recordset->fields('Bachelors MGPA')))
						$this->Bachelors_MGPA->CurrentValue = NULL;
					if (!ew_CompareValue($this->Other_Bachelors_Title->DbValue, $this->Recordset->fields('Other Bachelors Title')))
						$this->Other_Bachelors_Title->CurrentValue = NULL;
					if (!ew_CompareValue($this->Other_Bachelors_University->DbValue, $this->Recordset->fields('Other Bachelors University')))
						$this->Other_Bachelors_University->CurrentValue = NULL;
					if (!ew_CompareValue($this->Other_Bachelors_Major->DbValue, $this->Recordset->fields('Other Bachelors Major')))
						$this->Other_Bachelors_Major->CurrentValue = NULL;
					if (!ew_CompareValue($this->Other_Bachelors_GPA->DbValue, $this->Recordset->fields('Other Bachelors GPA')))
						$this->Other_Bachelors_GPA->CurrentValue = NULL;
					if (!ew_CompareValue($this->Other_Bachelors_MGPA->DbValue, $this->Recordset->fields('Other Bachelors MGPA')))
						$this->Other_Bachelors_MGPA->CurrentValue = NULL;
					if (!ew_CompareValue($this->Masters_Degree_Title->DbValue, $this->Recordset->fields('Masters Degree Title')))
						$this->Masters_Degree_Title->CurrentValue = NULL;
					if (!ew_CompareValue($this->Master_University->DbValue, $this->Recordset->fields('Master University')))
						$this->Master_University->CurrentValue = NULL;
					if (!ew_CompareValue($this->Masters_Degree_Major->DbValue, $this->Recordset->fields('Masters Degree Major')))
						$this->Masters_Degree_Major->CurrentValue = NULL;
					if (!ew_CompareValue($this->Masters_GPA->DbValue, $this->Recordset->fields('Masters GPA')))
						$this->Masters_GPA->CurrentValue = NULL;
					if (!ew_CompareValue($this->Other_Masters_Degree_Title->DbValue, $this->Recordset->fields('Other Masters Degree Title')))
						$this->Other_Masters_Degree_Title->CurrentValue = NULL;
					if (!ew_CompareValue($this->Other_Masters_University->DbValue, $this->Recordset->fields('Other Masters University')))
						$this->Other_Masters_University->CurrentValue = NULL;
					if (!ew_CompareValue($this->Other_Masters_Major->DbValue, $this->Recordset->fields('Other Masters Major')))
						$this->Other_Masters_Major->CurrentValue = NULL;
					if (!ew_CompareValue($this->Other_Masters_GPA->DbValue, $this->Recordset->fields('Other Masters GPA')))
						$this->Other_Masters_GPA->CurrentValue = NULL;
					if (!ew_CompareValue($this->PhD_Title->DbValue, $this->Recordset->fields('PhD Title')))
						$this->PhD_Title->CurrentValue = NULL;
					if (!ew_CompareValue($this->Phd_University->DbValue, $this->Recordset->fields('Phd University')))
						$this->Phd_University->CurrentValue = NULL;
					if (!ew_CompareValue($this->PhD_Major->DbValue, $this->Recordset->fields('PhD Major')))
						$this->PhD_Major->CurrentValue = NULL;
					if (!ew_CompareValue($this->Phd_Degree_Equivalency->DbValue, $this->Recordset->fields('Phd Degree Equivalency')))
						$this->Phd_Degree_Equivalency->CurrentValue = NULL;
					if (!ew_CompareValue($this->Committee_Meeting->DbValue, $this->Recordset->fields('Committee Meeting')))
						$this->Committee_Meeting->CurrentValue = NULL;
					if (!ew_CompareValue($this->Committee_Meeting_Number->DbValue, $this->Recordset->fields('Committee Meeting Number')))
						$this->Committee_Meeting_Number->CurrentValue = NULL;
					if (!ew_CompareValue($this->Committee_Date->DbValue, $this->Recordset->fields('Committee Date')))
	...
	function LoadFormValues() {
		...
		$this->Civil_ID->MultiUpdate = $objForm->GetValue("u_Civil_ID");
		if (!$this->Passport_No2E->FldIsDetailKey) {
			$this->Passport_No2E->setFormValue($objForm->GetValue("x_Passport_No2E"));
		}
		$this->Passport_No2E->MultiUpdate = $objForm->GetValue("u_Passport_No2E");
		...
		$this->Other_Bachelors_Title->MultiUpdate = $objForm->GetValue("u_Other_Bachelors_Title");
		...
		$this->Other_Bachelors_University->MultiUpdate = $objForm->GetValue("u_Other_Bachelors_University");
		...
		$this->Other_Bachelors_Major->MultiUpdate = $objForm->GetValue("u_Other_Bachelors_Major");
		if (!$this->Other_Bachelors_GPA->FldIsDetailKey) {
			$this->Other_Bachelors_GPA->setFormValue($objForm->GetValue("x_Other_Bachelors_GPA"));
		}
		$this->Other_Bachelors_GPA->MultiUpdate = $objForm->GetValue("u_Other_Bachelors_GPA");
		...
		$this->Other_Bachelors_MGPA->MultiUpdate = $objForm->GetValue("u_Other_Bachelors_MGPA");
		...
		$this->Masters_Degree_Title->MultiUpdate = $objForm->GetValue("u_Masters_Degree_Title");
		if (!$this->Master_University->FldIsDetailKey) {
			$this->Master_University->setFormValue($objForm->GetValue("x_Master_University"));
		}
		$this->Master_University->MultiUpdate = $objForm->GetValue("u_Master_University");
		...
		$this->Masters_Degree_Major->MultiUpdate = $objForm->GetValue("u_Masters_Degree_Major");
		if (!$this->Masters_GPA->FldIsDetailKey) {
			$this->Masters_GPA->setFormValue($objForm->GetValue("x_Masters_GPA"));
		}
		$this->Masters_GPA->MultiUpdate = $objForm->GetValue("u_Masters_GPA");
		...
		$this->Other_Masters_Degree_Title->MultiUpdate = $objForm->GetValue("u_Other_Masters_Degree_Title");
		...
		$this->Phd_Degree_Equivalency->MultiUpdate = $objForm->GetValue("u_Phd_Degree_Equivalency");
		if (!$this->Committee_Meeting->FldIsDetailKey) {
			$this->Committee_Meeting->setFormValue($objForm->GetValue("x_Committee_Meeting"));
		}
		$this->Committee_Meeting->MultiUpdate = $objForm->GetValue("u_Committee_Meeting");
		...
		$this->Committee_Meeting_Number->MultiUpdate = $objForm->GetValue("u_Committee_Meeting_Number");
		...
		$this->Committee_Date->MultiUpdate = $objForm->GetValue("u_Committee_Date");
	...
	function ValidateForm() {
		...
		if ($this->Civil_ID->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Passport_No2E->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Sector->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Job_Title->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Program->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->College->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Department->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Bachelors_Title->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Bachelor_University->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Bachelors_Major->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Bachelors_GPA->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Bachelors_MGPA->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Other_Bachelors_Title->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Other_Bachelors_University->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Other_Bachelors_Major->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Other_Bachelors_GPA->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Other_Bachelors_MGPA->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Masters_Degree_Title->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Master_University->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Masters_Degree_Major->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Masters_GPA->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Other_Masters_Degree_Title->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Other_Masters_University->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Other_Masters_Major->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Other_Masters_GPA->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->PhD_Title->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Phd_University->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->PhD_Major->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Phd_Degree_Equivalency->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Committee_Meeting->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Committee_Meeting_Number->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Committee_Date->MultiUpdate == "1") $lUpdateCnt++;
		...
		if ($this->Committee_Date->MultiUpdate <> "") {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Country
			$this->Country->SetDbValueDef($rsnew, $this->Country->CurrentValue, NULL, $this->Country->ReadOnly || $this->Country->MultiUpdate <> "1");

			// Civil ID
			$this->Civil_ID->SetDbValueDef($rsnew, $this->Civil_ID->CurrentValue, NULL, $this->Civil_ID->ReadOnly || $this->Civil_ID->MultiUpdate <> "1");

			// Passport No.
			$this->Passport_No2E->SetDbValueDef($rsnew, $this->Passport_No2E->CurrentValue, NULL, $this->Passport_No2E->ReadOnly || $this->Passport_No2E->MultiUpdate <> "1");

			// Sector
			$this->Sector->SetDbValueDef($rsnew, $this->Sector->CurrentValue, NULL, $this->Sector->ReadOnly || $this->Sector->MultiUpdate <> "1");

			// Job Title
			$this->Job_Title->SetDbValueDef($rsnew, $this->Job_Title->CurrentValue, NULL, $this->Job_Title->ReadOnly || $this->Job_Title->MultiUpdate <> "1");

			// Program
			$this->Program->SetDbValueDef($rsnew, $this->Program->CurrentValue, NULL, $this->Program->ReadOnly || $this->Program->MultiUpdate <> "1");

			// College
			$this->College->SetDbValueDef($rsnew, $this->College->CurrentValue, NULL, $this->College->ReadOnly || $this->College->MultiUpdate <> "1");
			...
			// Bachelors Title
			$this->Bachelors_Title->SetDbValueDef($rsnew, $this->Bachelors_Title->CurrentValue, NULL, $this->Bachelors_Title->ReadOnly || $this->Bachelors_Title->MultiUpdate <> "1");

			// Bachelor University
			$this->Bachelor_University->SetDbValueDef($rsnew, $this->Bachelor_University->CurrentValue, NULL, $this->Bachelor_University->ReadOnly || $this->Bachelor_University->MultiUpdate <> "1");

			// Bachelors Major
			$this->Bachelors_Major->SetDbValueDef($rsnew, $this->Bachelors_Major->CurrentValue, NULL, $this->Bachelors_Major->ReadOnly || $this->Bachelors_Major->MultiUpdate <> "1");

			// Bachelors GPA
			$this->Bachelors_GPA->SetDbValueDef($rsnew, $this->Bachelors_GPA->CurrentValue, NULL, $this->Bachelors_GPA->ReadOnly || $this->Bachelors_GPA->MultiUpdate <> "1");

			// Bachelors MGPA
			$this->Bachelors_MGPA->SetDbValueDef($rsnew, $this->Bachelors_MGPA->CurrentValue, NULL, $this->Bachelors_MGPA->ReadOnly || $this->Bachelors_MGPA->MultiUpdate <> "1");

			// Other Bachelors Title
			$this->Other_Bachelors_Title->SetDbValueDef($rsnew, $this->Other_Bachelors_Title->CurrentValue, NULL, $this->Other_Bachelors_Title->ReadOnly || $this->Other_Bachelors_Title->MultiUpdate <> "1");

			// Other Bachelors University
			$this->Other_Bachelors_University->SetDbValueDef($rsnew, $this->Other_Bachelors_University->CurrentValue, NULL, $this->Other_Bachelors_University->ReadOnly || $this->Other_Bachelors_University->MultiUpdate <> "1");

			// Other Bachelors Major
			$this->Other_Bachelors_Major->SetDbValueDef($rsnew, $this->Other_Bachelors_Major->CurrentValue, NULL, $this->Other_Bachelors_Major->ReadOnly || $this->Other_Bachelors_Major->MultiUpdate <> "1");

			// Other Bachelors GPA
			$this->Other_Bachelors_GPA->SetDbValueDef($rsnew, $this->Other_Bachelors_GPA->CurrentValue, NULL, $this->Other_Bachelors_GPA->ReadOnly || $this->Other_Bachelors_GPA->MultiUpdate <> "1");

			// Other Bachelors MGPA
			$this->Other_Bachelors_MGPA->SetDbValueDef($rsnew, $this->Other_Bachelors_MGPA->CurrentValue, NULL, $this->Other_Bachelors_MGPA->ReadOnly || $this->Other_Bachelors_MGPA->MultiUpdate <> "1");

			// Masters Degree Title
			$this->Masters_Degree_Title->SetDbValueDef($rsnew, $this->Masters_Degree_Title->CurrentValue, NULL, $this->Masters_Degree_Title->ReadOnly || $this->Masters_Degree_Title->MultiUpdate <> "1");

			// Master University
			$this->Master_University->SetDbValueDef($rsnew, $this->Master_University->CurrentValue, NULL, $this->Master_University->ReadOnly || $this->Master_University->MultiUpdate <> "1");

			// Masters Degree Major
			$this->Masters_Degree_Major->SetDbValueDef($rsnew, $this->Masters_Degree_Major->CurrentValue, NULL, $this->Masters_Degree_Major->ReadOnly || $this->Masters_Degree_Major->MultiUpdate <> "1");

			// Masters GPA
			$this->Masters_GPA->SetDbValueDef($rsnew, $this->Masters_GPA->CurrentValue, NULL, $this->Masters_GPA->ReadOnly || $this->Masters_GPA->MultiUpdate <> "1");

			// Other Masters Degree Title
			$this->Other_Masters_Degree_Title->SetDbValueDef($rsnew, $this->Other_Masters_Degree_Title->CurrentValue, NULL, $this->Other_Masters_Degree_Title->ReadOnly || $this->Other_Masters_Degree_Title->MultiUpdate <> "1");

			// Other Masters University
			$this->Other_Masters_University->SetDbValueDef($rsnew, $this->Other_Masters_University->CurrentValue, NULL, $this->Other_Masters_University->ReadOnly || $this->Other_Masters_University->MultiUpdate <> "1");

			// Other Masters Major
			$this->Other_Masters_Major->SetDbValueDef($rsnew, $this->Other_Masters_Major->CurrentValue, NULL, $this->Other_Masters_Major->ReadOnly || $this->Other_Masters_Major->MultiUpdate <> "1");

			// Other Masters GPA
			$this->Other_Masters_GPA->SetDbValueDef($rsnew, $this->Other_Masters_GPA->CurrentValue, NULL, $this->Other_Masters_GPA->ReadOnly || $this->Other_Masters_GPA->MultiUpdate <> "1");

			// PhD Title
			$this->PhD_Title->SetDbValueDef($rsnew, $this->PhD_Title->CurrentValue, NULL, $this->PhD_Title->ReadOnly || $this->PhD_Title->MultiUpdate <> "1");

			// Phd University
			$this->Phd_University->SetDbValueDef($rsnew, $this->Phd_University->CurrentValue, NULL, $this->Phd_University->ReadOnly || $this->Phd_University->MultiUpdate <> "1");

			// PhD Major
			$this->PhD_Major->SetDbValueDef($rsnew, $this->PhD_Major->CurrentValue, NULL, $this->PhD_Major->ReadOnly || $this->PhD_Major->MultiUpdate <> "1");

			// Phd Degree Equivalency
			$this->Phd_Degree_Equivalency->SetDbValueDef($rsnew, $this->Phd_Degree_Equivalency->CurrentValue, NULL, $this->Phd_Degree_Equivalency->ReadOnly || $this->Phd_Degree_Equivalency->MultiUpdate <> "1");

			// Committee Meeting
			$this->Committee_Meeting->SetDbValueDef($rsnew, $this->Committee_Meeting->CurrentValue, NULL, $this->Committee_Meeting->ReadOnly || $this->Committee_Meeting->MultiUpdate <> "1");

			// Committee Meeting Number
			$this->Committee_Meeting_Number->SetDbValueDef($rsnew, $this->Committee_Meeting_Number->CurrentValue, NULL, $this->Committee_Meeting_Number->ReadOnly || $this->Committee_Meeting_Number->MultiUpdate <> "1");

			// Committee Date
			$this->Committee_Date->SetDbValueDef($rsnew, $this->Committee_Date->CurrentValue, NULL, $this->Committee_Date->ReadOnly || $this->Committee_Date->MultiUpdate <> "1");
...
// Create page object
if (!isset($gpa_equivalency_update)) $gpa_equivalency_update = new cgpa_equivalency_update();

// Page init
$gpa_equivalency_update->Page_Init();

// Page main
$gpa_equivalency_update->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$gpa_equivalency_update->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var gpa_equivalency_update = new ew_Page("gpa_equivalency_update");
gpa_equivalency_update.PageID = "update"; // Page ID
var EW_PAGE_ID = gpa_equivalency_update.PageID; // For backward compatibility

// Form object
var fgpa_equivalencyupdate = new ew_Form("fgpa_equivalencyupdate");

// Validate form
fgpa_equivalencyupdate.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			uelm = this.GetElements("u" + infix + "_Committee_Date");
...
fgpa_equivalencyupdate.Form_CustomValidate = 
...
fgpa_equivalencyupdate.ValidateRequired = true;
<?php } else { ?>
fgpa_equivalencyupdate.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fgpa_equivalencyupdate.Lists["x_Country"] = {"LinkField":"x_NID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Nationality","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fgpa_equivalencyupdate.Lists["x_Sector"] = {"LinkField":"x_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Sector","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fgpa_equivalencyupdate.Lists["x_Job_Title"] = {"LinkField":"x_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Job_Title","","",""],"ParentFields":["x_Sector"],"FilterFields":["x_Sector_ID"],"Options":[]};
fgpa_equivalencyupdate.Lists["x_College"] = {"LinkField":"x_CollegeID","Ajax":null,"AutoFill":false,"DisplayFields":["x_College_Name_AR","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fgpa_equivalencyupdate.Lists["x_Department"] = {"LinkField":"x_DID","Ajax":null,"AutoFill":false,"DisplayFields":["x_DepartmentName2DAR","","",""],"ParentFields":["x_College"],"FilterFields":["x_CID"],"Options":[]};
fgpa_equivalencyupdate.Lists["x_Bachelors_GPA"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Grade","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fgpa_equivalencyupdate.Lists["x_Bachelors_MGPA"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Grade","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fgpa_equivalencyupdate.Lists["x_Other_Bachelors_GPA"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Grade","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fgpa_equivalencyupdate.Lists["x_Other_Bachelors_MGPA"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Grade","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fgpa_equivalencyupdate.Lists["x_Masters_GPA"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Grade","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fgpa_equivalencyupdate.Lists["x_Other_Masters_GPA"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Grade","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $gpa_equivalency_update->ShowPageHeader(); ?>
<?php
$gpa_equivalency_update->ShowMessage();
?>
<form name="fgpa_equivalencyupdate" id="fgpa_equivalencyupdate" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="gpa_equivalency">
<input type="hidden" name="a_update" id="a_update" value="U">
<?php foreach ($gpa_equivalency_update->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<table class="ewGrid"><tr><td>
<table id="tbl_gpa_equivalencyupdate" class="table table-bordered table-striped">
<thead>
	<tr>
...
<?php if ($gpa_equivalency->Name->Visible) { // Name ?>
	<tr id="r_Name">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Name->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Name" id="u_Name" value="1"<?php echo ($gpa_equivalency->Name->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Name->CellAttributes() ?>><span id="elh_gpa_equivalency_Name"><?php echo $gpa_equivalency->Name->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Country->Visible) { // Country ?>
	<tr id="r_Country">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Country->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Country" id="u_Country" value="1"<?php echo ($gpa_equivalency->Country->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Country->CellAttributes() ?>><span id="elh_gpa_equivalency_Country"><?php echo $gpa_equivalency->Country->FldCaption() ?></span></td>
...
<script type="text/javascript">
fgpa_equivalencyupdate.Lists["x_Country"].Options = <?php echo (is_array($gpa_equivalency->Country->EditValue)) ? ew_ArrayToJson($gpa_equivalency->Country->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php if ($gpa_equivalency->Civil_ID->Visible) { // Civil ID ?>
	<tr id="r_Civil_ID">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Civil_ID->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Civil_ID" id="u_Civil_ID" value="1"<?php echo ($gpa_equivalency->Civil_ID->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Civil_ID->CellAttributes() ?>><span id="elh_gpa_equivalency_Civil_ID"><?php echo $gpa_equivalency->Civil_ID->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Passport_No2E->Visible) { // Passport No. ?>
	<tr id="r_Passport_No2E">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Passport_No2E->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Passport_No2E" id="u_Passport_No2E" value="1"<?php echo ($gpa_equivalency->Passport_No2E->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Passport_No2E->CellAttributes() ?>><span id="elh_gpa_equivalency_Passport_No2E"><?php echo $gpa_equivalency->Passport_No2E->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Sector->Visible) { // Sector ?>
	<tr id="r_Sector">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Sector->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Sector" id="u_Sector" value="1"<?php echo ($gpa_equivalency->Sector->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Sector->CellAttributes() ?>><span id="elh_gpa_equivalency_Sector"><?php echo $gpa_equivalency->Sector->FldCaption() ?></span></td>
...
<script type="text/javascript">
fgpa_equivalencyupdate.Lists["x_Sector"].Options = <?php echo (is_array($gpa_equivalency->Sector->EditValue)) ? ew_ArrayToJson($gpa_equivalency->Sector->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php if ($gpa_equivalency->Job_Title->Visible) { // Job Title ?>
	<tr id="r_Job_Title">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Job_Title->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Job_Title" id="u_Job_Title" value="1"<?php echo ($gpa_equivalency->Job_Title->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Job_Title->CellAttributes() ?>><span id="elh_gpa_equivalency_Job_Title"><?php echo $gpa_equivalency->Job_Title->FldCaption() ?></span></td>
...
<script type="text/javascript">
fgpa_equivalencyupdate.Lists["x_Job_Title"].Options = <?php echo (is_array($gpa_equivalency->Job_Title->EditValue)) ? ew_ArrayToJson($gpa_equivalency->Job_Title->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php if ($gpa_equivalency->Program->Visible) { // Program ?>
	<tr id="r_Program">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Program->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Program" id="u_Program" value="1"<?php echo ($gpa_equivalency->Program->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Program->CellAttributes() ?>><span id="elh_gpa_equivalency_Program"><?php echo $gpa_equivalency->Program->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->College->Visible) { // College ?>
	<tr id="r_College">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->College->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_College" id="u_College" value="1"<?php echo ($gpa_equivalency->College->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->College->CellAttributes() ?>><span id="elh_gpa_equivalency_College"><?php echo $gpa_equivalency->College->FldCaption() ?></span></td>
...
<script type="text/javascript">
fgpa_equivalencyupdate.Lists["x_College"].Options = <?php echo (is_array($gpa_equivalency->College->EditValue)) ? ew_ArrayToJson($gpa_equivalency->College->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php if ($gpa_equivalency->Department->Visible) { // Department ?>
	<tr id="r_Department">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Department->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Department" id="u_Department" value="1"<?php echo ($gpa_equivalency->Department->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Department->CellAttributes() ?>><span id="elh_gpa_equivalency_Department"><?php echo $gpa_equivalency->Department->FldCaption() ?></span></td>
...
<script type="text/javascript">
fgpa_equivalencyupdate.Lists["x_Department"].Options = <?php echo (is_array($gpa_equivalency->Department->EditValue)) ? ew_ArrayToJson($gpa_equivalency->Department->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php if ($gpa_equivalency->Bachelors_Title->Visible) { // Bachelors Title ?>
	<tr id="r_Bachelors_Title">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Bachelors_Title->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Bachelors_Title" id="u_Bachelors_Title" value="1"<?php echo ($gpa_equivalency->Bachelors_Title->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Bachelors_Title->CellAttributes() ?>><span id="elh_gpa_equivalency_Bachelors_Title"><?php echo $gpa_equivalency->Bachelors_Title->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Bachelor_University->Visible) { // Bachelor University ?>
	<tr id="r_Bachelor_University">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Bachelor_University->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Bachelor_University" id="u_Bachelor_University" value="1"<?php echo ($gpa_equivalency->Bachelor_University->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Bachelor_University->CellAttributes() ?>><span id="elh_gpa_equivalency_Bachelor_University"><?php echo $gpa_equivalency->Bachelor_University->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Bachelors_Major->Visible) { // Bachelors Major ?>
	<tr id="r_Bachelors_Major">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Bachelors_Major->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Bachelors_Major" id="u_Bachelors_Major" value="1"<?php echo ($gpa_equivalency->Bachelors_Major->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Bachelors_Major->CellAttributes() ?>><span id="elh_gpa_equivalency_Bachelors_Major"><?php echo $gpa_equivalency->Bachelors_Major->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Bachelors_GPA->Visible) { // Bachelors GPA ?>
	<tr id="r_Bachelors_GPA">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Bachelors_GPA->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Bachelors_GPA" id="u_Bachelors_GPA" value="1"<?php echo ($gpa_equivalency->Bachelors_GPA->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Bachelors_GPA->CellAttributes() ?>><span id="elh_gpa_equivalency_Bachelors_GPA"><?php echo $gpa_equivalency->Bachelors_GPA->FldCaption() ?></span></td>
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_Bachelors_GPA", fgpa_equivalencyupdate, false, EW_AUTO_SUGGEST_MAX_ENTRIES);
...
fgpa_equivalencyupdate.AutoSuggests["x_Bachelors_GPA"] = oas;
</script>
</span>
...
<?php if ($gpa_equivalency->Bachelors_MGPA->Visible) { // Bachelors MGPA ?>
	<tr id="r_Bachelors_MGPA">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Bachelors_MGPA->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Bachelors_MGPA" id="u_Bachelors_MGPA" value="1"<?php echo ($gpa_equivalency->Bachelors_MGPA->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Bachelors_MGPA->CellAttributes() ?>><span id="elh_gpa_equivalency_Bachelors_MGPA"><?php echo $gpa_equivalency->Bachelors_MGPA->FldCaption() ?></span></td>
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_Bachelors_MGPA", fgpa_equivalencyupdate, false, EW_AUTO_SUGGEST_MAX_ENTRIES);
oas.formatResult = function(ar) {
	var dv = ar[1];
	for (var i = 2; i <= 4; i++)
...
fgpa_equivalencyupdate.AutoSuggests["x_Bachelors_MGPA"] = oas;
</script>
</span>
...
<?php if ($gpa_equivalency->Other_Bachelors_Title->Visible) { // Other Bachelors Title ?>
	<tr id="r_Other_Bachelors_Title">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Other_Bachelors_Title->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Other_Bachelors_Title" id="u_Other_Bachelors_Title" value="1"<?php echo ($gpa_equivalency->Other_Bachelors_Title->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Other_Bachelors_Title->CellAttributes() ?>><span id="elh_gpa_equivalency_Other_Bachelors_Title"><?php echo $gpa_equivalency->Other_Bachelors_Title->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Other_Bachelors_University->Visible) { // Other Bachelors University ?>
	<tr id="r_Other_Bachelors_University">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Other_Bachelors_University->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Other_Bachelors_University" id="u_Other_Bachelors_University" value="1"<?php echo ($gpa_equivalency->Other_Bachelors_University->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Other_Bachelors_University->CellAttributes() ?>><span id="elh_gpa_equivalency_Other_Bachelors_University"><?php echo $gpa_equivalency->Other_Bachelors_University->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Other_Bachelors_Major->Visible) { // Other Bachelors Major ?>
	<tr id="r_Other_Bachelors_Major">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Other_Bachelors_Major->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Other_Bachelors_Major" id="u_Other_Bachelors_Major" value="1"<?php echo ($gpa_equivalency->Other_Bachelors_Major->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Other_Bachelors_Major->CellAttributes() ?>><span id="elh_gpa_equivalency_Other_Bachelors_Major"><?php echo $gpa_equivalency->Other_Bachelors_Major->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Other_Bachelors_GPA->Visible) { // Other Bachelors GPA ?>
	<tr id="r_Other_Bachelors_GPA">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Other_Bachelors_GPA->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Other_Bachelors_GPA" id="u_Other_Bachelors_GPA" value="1"<?php echo ($gpa_equivalency->Other_Bachelors_GPA->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Other_Bachelors_GPA->CellAttributes() ?>><span id="elh_gpa_equivalency_Other_Bachelors_GPA"><?php echo $gpa_equivalency->Other_Bachelors_GPA->FldCaption() ?></span></td>
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_Other_Bachelors_GPA", fgpa_equivalencyupdate, false, EW_AUTO_SUGGEST_MAX_ENTRIES);
oas.formatResult = function(ar) {
	var dv = ar[1];
	for (var i = 2; i <= 4; i++)
...
fgpa_equivalencyupdate.AutoSuggests["x_Other_Bachelors_GPA"] = oas;
</script>
</span>
...
<?php if ($gpa_equivalency->Other_Bachelors_MGPA->Visible) { // Other Bachelors MGPA ?>
	<tr id="r_Other_Bachelors_MGPA">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Other_Bachelors_MGPA->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Other_Bachelors_MGPA" id="u_Other_Bachelors_MGPA" value="1"<?php echo ($gpa_equivalency->Other_Bachelors_MGPA->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Other_Bachelors_MGPA->CellAttributes() ?>><span id="elh_gpa_equivalency_Other_Bachelors_MGPA"><?php echo $gpa_equivalency->Other_Bachelors_MGPA->FldCaption() ?></span></td>
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_Other_Bachelors_MGPA", fgpa_equivalencyupdate, false, EW_AUTO_SUGGEST_MAX_ENTRIES);
oas.formatResult = function(ar) {
	var dv = ar[1];
	for (var i = 2; i <= 4; i++)
...
fgpa_equivalencyupdate.AutoSuggests["x_Other_Bachelors_MGPA"] = oas;
</script>
</span>
...
<?php if ($gpa_equivalency->Masters_Degree_Title->Visible) { // Masters Degree Title ?>
	<tr id="r_Masters_Degree_Title">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Masters_Degree_Title->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Masters_Degree_Title" id="u_Masters_Degree_Title" value="1"<?php echo ($gpa_equivalency->Masters_Degree_Title->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Masters_Degree_Title->CellAttributes() ?>><span id="elh_gpa_equivalency_Masters_Degree_Title"><?php echo $gpa_equivalency->Masters_Degree_Title->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Master_University->Visible) { // Master University ?>
	<tr id="r_Master_University">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Master_University->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Master_University" id="u_Master_University" value="1"<?php echo ($gpa_equivalency->Master_University->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Master_University->CellAttributes() ?>><span id="elh_gpa_equivalency_Master_University"><?php echo $gpa_equivalency->Master_University->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Masters_Degree_Major->Visible) { // Masters Degree Major ?>
	<tr id="r_Masters_Degree_Major">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Masters_Degree_Major->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Masters_Degree_Major" id="u_Masters_Degree_Major" value="1"<?php echo ($gpa_equivalency->Masters_Degree_Major->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Masters_Degree_Major->CellAttributes() ?>><span id="elh_gpa_equivalency_Masters_Degree_Major"><?php echo $gpa_equivalency->Masters_Degree_Major->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Masters_GPA->Visible) { // Masters GPA ?>
	<tr id="r_Masters_GPA">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Masters_GPA->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Masters_GPA" id="u_Masters_GPA" value="1"<?php echo ($gpa_equivalency->Masters_GPA->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Masters_GPA->CellAttributes() ?>><span id="elh_gpa_equivalency_Masters_GPA"><?php echo $gpa_equivalency->Masters_GPA->FldCaption() ?></span></td>
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_Masters_GPA", fgpa_equivalencyupdate, false, EW_AUTO_SUGGEST_MAX_ENTRIES);
oas.formatResult = function(ar) {
	var dv = ar[1];
	for (var i = 2; i <= 4; i++)
...
fgpa_equivalencyupdate.AutoSuggests["x_Masters_GPA"] = oas;
</script>
</span>
...
<?php if ($gpa_equivalency->Other_Masters_Degree_Title->Visible) { // Other Masters Degree Title ?>
	<tr id="r_Other_Masters_Degree_Title">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Other_Masters_Degree_Title->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Other_Masters_Degree_Title" id="u_Other_Masters_Degree_Title" value="1"<?php echo ($gpa_equivalency->Other_Masters_Degree_Title->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Other_Masters_Degree_Title->CellAttributes() ?>><span id="elh_gpa_equivalency_Other_Masters_Degree_Title"><?php echo $gpa_equivalency->Other_Masters_Degree_Title->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Other_Masters_University->Visible) { // Other Masters University ?>
	<tr id="r_Other_Masters_University">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Other_Masters_University->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Other_Masters_University" id="u_Other_Masters_University" value="1"<?php echo ($gpa_equivalency->Other_Masters_University->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Other_Masters_University->CellAttributes() ?>><span id="elh_gpa_equivalency_Other_Masters_University"><?php echo $gpa_equivalency->Other_Masters_University->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Other_Masters_Major->Visible) { // Other Masters Major ?>
	<tr id="r_Other_Masters_Major">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Other_Masters_Major->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Other_Masters_Major" id="u_Other_Masters_Major" value="1"<?php echo ($gpa_equivalency->Other_Masters_Major->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Other_Masters_Major->CellAttributes() ?>><span id="elh_gpa_equivalency_Other_Masters_Major"><?php echo $gpa_equivalency->Other_Masters_Major->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Other_Masters_GPA->Visible) { // Other Masters GPA ?>
	<tr id="r_Other_Masters_GPA">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Other_Masters_GPA->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Other_Masters_GPA" id="u_Other_Masters_GPA" value="1"<?php echo ($gpa_equivalency->Other_Masters_GPA->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Other_Masters_GPA->CellAttributes() ?>><span id="elh_gpa_equivalency_Other_Masters_GPA"><?php echo $gpa_equivalency->Other_Masters_GPA->FldCaption() ?></span></td>
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_Other_Masters_GPA", fgpa_equivalencyupdate, false, EW_AUTO_SUGGEST_MAX_ENTRIES);
oas.formatResult = function(ar) {
	var dv = ar[1];
	for (var i = 2; i <= 4; i++)
...
fgpa_equivalencyupdate.AutoSuggests["x_Other_Masters_GPA"] = oas;
</script>
</span>
...
<?php if ($gpa_equivalency->PhD_Title->Visible) { // PhD Title ?>
	<tr id="r_PhD_Title">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->PhD_Title->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_PhD_Title" id="u_PhD_Title" value="1"<?php echo ($gpa_equivalency->PhD_Title->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->PhD_Title->CellAttributes() ?>><span id="elh_gpa_equivalency_PhD_Title"><?php echo $gpa_equivalency->PhD_Title->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Phd_University->Visible) { // Phd University ?>
	<tr id="r_Phd_University">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Phd_University->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Phd_University" id="u_Phd_University" value="1"<?php echo ($gpa_equivalency->Phd_University->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Phd_University->CellAttributes() ?>><span id="elh_gpa_equivalency_Phd_University"><?php echo $gpa_equivalency->Phd_University->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->PhD_Major->Visible) { // PhD Major ?>
	<tr id="r_PhD_Major">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->PhD_Major->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_PhD_Major" id="u_PhD_Major" value="1"<?php echo ($gpa_equivalency->PhD_Major->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->PhD_Major->CellAttributes() ?>><span id="elh_gpa_equivalency_PhD_Major"><?php echo $gpa_equivalency->PhD_Major->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Phd_Degree_Equivalency->Visible) { // Phd Degree Equivalency ?>
	<tr id="r_Phd_Degree_Equivalency">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Phd_Degree_Equivalency->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Phd_Degree_Equivalency" id="u_Phd_Degree_Equivalency" value="1"<?php echo ($gpa_equivalency->Phd_Degree_Equivalency->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Phd_Degree_Equivalency->CellAttributes() ?>><span id="elh_gpa_equivalency_Phd_Degree_Equivalency"><?php echo $gpa_equivalency->Phd_Degree_Equivalency->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Committee_Meeting->Visible) { // Committee Meeting ?>
	<tr id="r_Committee_Meeting">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Committee_Meeting->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Committee_Meeting" id="u_Committee_Meeting" value="1"<?php echo ($gpa_equivalency->Committee_Meeting->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Committee_Meeting->CellAttributes() ?>><span id="elh_gpa_equivalency_Committee_Meeting"><?php echo $gpa_equivalency->Committee_Meeting->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Committee_Meeting_Number->Visible) { // Committee Meeting Number ?>
	<tr id="r_Committee_Meeting_Number">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Committee_Meeting_Number->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Committee_Meeting_Number" id="u_Committee_Meeting_Number" value="1"<?php echo ($gpa_equivalency->Committee_Meeting_Number->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Committee_Meeting_Number->CellAttributes() ?>><span id="elh_gpa_equivalency_Committee_Meeting_Number"><?php echo $gpa_equivalency->Committee_Meeting_Number->FldCaption() ?></span></td>
...
<?php if ($gpa_equivalency->Committee_Date->Visible) { // Committee Date ?>
	<tr id="r_Committee_Date">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Committee_Date->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Committee_Date" id="u_Committee_Date" value="1"<?php echo ($gpa_equivalency->Committee_Date->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Committee_Date->CellAttributes() ?>><span id="elh_gpa_equivalency_Committee_Date"><?php echo $gpa_equivalency->Committee_Date->FldCaption() ?></span></td>
...
ew_CreateCalendar("fgpa_equivalencyupdate", "x_Committee_Date", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<?php if ($gpa_equivalency->Notes->Visible) { // Notes ?>
	<tr id="r_Notes">
		<td class="ewCheckbox"<?php echo $gpa_equivalency->Notes->CellAttributes() ?>>
<label class="checkbox"><input type="checkbox" name="u_Notes" id="u_Notes" value="1"<?php echo ($gpa_equivalency->Notes->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>></label>
</td>
		<td<?php echo $gpa_equivalency->Notes->CellAttributes() ?>><span id="elh_gpa_equivalency_Notes"><?php echo $gpa_equivalency->Notes->FldCaption() ?></span></td>
...
<script type="text/javascript">
fgpa_equivalencyupdate.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$gpa_equivalency_update->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$gpa_equivalency_update->Page_Terminate();
?>
