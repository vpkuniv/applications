...
$colleges_view = NULL; // Initialize page object first

class ccolleges_view extends ccolleges {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["CollegeID"] <> "") {
			$this->RecKey["CollegeID"] = $_GET["CollegeID"];
			$KeyUrl .= "&amp;CollegeID=" . urlencode($this->RecKey["CollegeID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["CollegeID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["CollegeID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["CollegeID"] <> "") {
				...
				$this->RecKey["CollegeID"] = $this->CollegeID->QueryStringValue;
			} else {
				$sReturnUrl = "collegeslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "collegeslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "collegeslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_colleges\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_colleges',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fcollegesview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($colleges_view)) $colleges_view = new ccolleges_view();

// Page init
$colleges_view->Page_Init();

// Page main
$colleges_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$colleges_view->Page_Render();
?>
...
// Page object
var colleges_view = new ew_Page("colleges_view");
colleges_view.PageID = "view"; // Page ID
var EW_PAGE_ID = colleges_view.PageID; // For backward compatibility

// Form object
var fcollegesview = new ew_Form("fcollegesview");

// Form_CustomValidate event
fcollegesview.Form_CustomValidate = 
...
fcollegesview.ValidateRequired = true;
<?php } else { ?>
fcollegesview.ValidateRequired = false; 
<?php } ?>
...
<?php $colleges_view->ExportOptions->Render("body") ?>
<?php if (!$colleges_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($colleges_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $colleges_view->ShowPageHeader(); ?>
<?php
$colleges_view->ShowMessage();
?>
<form name="fcollegesview" id="fcollegesview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="colleges">
<table class="ewGrid"><tr><td>
<table id="tbl_collegesview" class="table table-bordered table-striped">
...
<?php echo $colleges->CollegeID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($colleges->College_Name_EN->Visible) { // College Name EN ?>
	<tr id="r_College_Name_EN">
		<td><span id="elh_colleges_College_Name_EN"><?php echo $colleges->College_Name_EN->FldCaption() ?></span></td>
...
<?php echo $colleges->College_Name_EN->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($colleges->College_Name_AR->Visible) { // College Name AR ?>
	<tr id="r_College_Name_AR">
		<td><span id="elh_colleges_College_Name_AR"><?php echo $colleges->College_Name_AR->FldCaption() ?></span></td>
...
<?php echo $colleges->College_Name_AR->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
