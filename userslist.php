...
class cusers_list extends cusers {
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->User_Level); // User Level
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<label class=\"checkbox\"><input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->_userID->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'></label>";
...
<?php if ($users->_userID->Visible) { // userID ?>
	<?php if ($users->SortUrl($users->_userID) == "") { ?>
		<td><div id="elh_users__userID" class="users__userID"><div class="ewTableHeaderCaption"><?php echo $users->_userID->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->_userID) ?>',1);"><div id="elh_users__userID" class="users__userID">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->_userID->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->_userID->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->_userID->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($users->User_Level->Visible) { // User Level ?>
	<?php if ($users->SortUrl($users->User_Level) == "") { ?>
		<td><div id="elh_users_User_Level" class="users_User_Level"><div class="ewTableHeaderCaption"><?php echo $users->User_Level->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->User_Level) ?>',1);"><div id="elh_users_User_Level" class="users_User_Level">
