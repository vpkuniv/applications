...
class csectors_view extends csectors {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_sectors\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_sectors',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fsectorsview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Page object
var sectors_view = new ew_Page("sectors_view");
sectors_view.PageID = "view"; // Page ID
var EW_PAGE_ID = sectors_view.PageID; // For backward compatibility

// Form object
var fsectorsview = new ew_Form("fsectorsview");
...
<?php if (!$sectors_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fsectorsview" id="fsectorsview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="sectors">
<table class="ewGrid"><tr><td>
<table id="tbl_sectorsview" class="table table-bordered table-striped">
...
<span id="el_sectors_ID" class="control-group">
...
<?php if ($sectors->Sector->Visible) { // Sector ?>
	<tr id="r_Sector">
		<td><span id="elh_sectors_Sector"><?php echo $sectors->Sector->FldCaption() ?></span></td>
...
<?php echo $sectors->Sector->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
