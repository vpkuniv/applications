...
class ccountries_edit extends ccountries {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->NID->FldIsDetailKey)
			$this->NID->setFormValue($objForm->GetValue("x_NID"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->NID->CurrentValue = $this->NID->FormValue;
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			// NID
			$this->NID->EditCustomAttributes = "";
			$this->NID->EditValue = $this->NID->CurrentValue;
			$this->NID->ViewCustomAttributes = "";
...
<?php echo $countries->NID->EditValue ?></span>
</span>
<input type="hidden" data-field="x_NID" name="x_NID" id="x_NID" value="<?php echo ew_HtmlEncode($countries->NID->CurrentValue) ?>">
<?php echo $countries->NID->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<?php echo $countries->Nationality->EditValue ?></span>
</span>
<input type="hidden" data-field="x_Nationality" name="x_Nationality" id="x_Nationality" value="<?php echo ew_HtmlEncode($countries->Nationality->CurrentValue) ?>">
