...
class csectors extends cTable {
	...
	function __construct() {
		...
		// ID
		$this->ID = new cField('sectors', 'sectors', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] = &$this->ID;

		// Sector
		$this->Sector = new cField('sectors', 'sectors', 'x_Sector', 'Sector', '`Sector`', '`Sector`', 200, -1, FALSE, '`Sector`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("sectorsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("sectorsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "sectorsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("sectorsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("sectorsadd.php", $this->UrlParm($parm));
	}
