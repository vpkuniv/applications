...
<?php if ($countries->NID->Visible) { // NID ?>
		<td><span id="elh_countries_NID" class="countries_NID"><?php echo $countries->NID->FldCaption() ?></span></td>
<?php } ?>
<?php if ($countries->Nationality->Visible) { // Nationality ?>
		<td><span id="elh_countries_Nationality" class="countries_Nationality"><?php echo $countries->Nationality->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $countries_delete->RowCnt ?>_countries_NID" class="control-group countries_NID">
...
<span id="el<?php echo $countries_delete->RowCnt ?>_countries_Nationality" class="control-group countries_Nationality">
