...
class ccountries_list extends ccountries {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->NID->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->NID->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<label class=\"checkbox\"><input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->NID->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'></label>";
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" href=\"\" onclick=\"ew_SubmitSelected(document.fcountrieslist, '" . $this->MultiDeleteUrl . "');return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->CanDelete());
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_countries\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_countries',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fcountrieslist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
<?php if ($countries->NID->Visible) { // NID ?>
	<?php if ($countries->SortUrl($countries->NID) == "") { ?>
		<td><div id="elh_countries_NID" class="countries_NID"><div class="ewTableHeaderCaption" style="white-space: nowrap;"><?php echo $countries->NID->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $countries->SortUrl($countries->NID) ?>',1);"><div id="elh_countries_NID" class="countries_NID">
			<div class="ewTableHeaderBtn" style="white-space: nowrap;"><span class="ewTableHeaderCaption"><?php echo $countries->NID->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($countries->NID->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($countries->NID->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($countries->Nationality->Visible) { // Nationality ?>
	<?php if ($countries->SortUrl($countries->Nationality) == "") { ?>
		<td><div id="elh_countries_Nationality" class="countries_Nationality"><div class="ewTableHeaderCaption" style="white-space: nowrap;"><?php echo $countries->Nationality->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $countries->SortUrl($countries->Nationality) ?>',1);"><div id="elh_countries_Nationality" class="countries_Nationality">
			<div class="ewTableHeaderBtn" style="white-space: nowrap;"><span class="ewTableHeaderCaption"><?php echo $countries->Nationality->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($countries->Nationality->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($countries->Nationality->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<?php echo $countries->NID->ListViewValue() ?></span>
...
<?php echo $countries->Nationality->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
