...
define("EW_PROJECT_NAME", "vpaa", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{F8E6AD82-57C4-4BEE-8975-8D386184467A}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'RXwSi854kgn565xl', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/vpaa.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'vpaa', TRUE);
define("EW_CONN_PASS", '3XNxLq9rPPxzf5TR', TRUE);
define("EW_CONN_DB", 'vpaa', TRUE);
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "`audit`", TRUE); // Audit trail table name
...
// Security
define("EW_ADMIN_USER_NAME", "vpaasuperadmin", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "superadmin9618*", TRUE); // Administrator password
...
// File upload
define("EW_UPLOAD_DEST_PATH", "File_Uploads/", TRUE); // Upload destination path (relative to app root)
...
// Audit trail
define("EW_AUDIT_TRAIL_PATH", "audit/", TRUE); // Audit trail path (relative to app root)
...
define("EW_PDF_MEMORY_LIMIT", "256M", TRUE); // Memory limit
define("EW_PDF_TIME_LIMIT", 140, TRUE); // Time limit
?>
