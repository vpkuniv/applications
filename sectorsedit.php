...
// Page object
var sectors_edit = new ew_Page("sectors_edit");
sectors_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = sectors_edit.PageID; // For backward compatibility

// Form object
var fsectorsedit = new ew_Form("fsectorsedit");
...
?>
<form name="fsectorsedit" id="fsectorsedit" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="sectors">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_sectorsedit" class="table table-bordered table-striped">
...
<?php echo $sectors->ID->EditValue ?></span>
</span>
<input type="hidden" data-field="x_ID" name="x_ID" id="x_ID" value="<?php echo ew_HtmlEncode($sectors->ID->CurrentValue) ?>">
<?php echo $sectors->ID->CustomMsg ?></td>
	</tr>
<?php } ?>
