...
$gpa_list_add = NULL; // Initialize page object first

class cgpa_list_add extends cgpa_list {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "gpa_listview.php")
...
// Create page object
if (!isset($gpa_list_add)) $gpa_list_add = new cgpa_list_add();

// Page init
$gpa_list_add->Page_Init();

// Page main
$gpa_list_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$gpa_list_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var gpa_list_add = new ew_Page("gpa_list_add");
gpa_list_add.PageID = "add"; // Page ID
var EW_PAGE_ID = gpa_list_add.PageID; // For backward compatibility

// Form object
var fgpa_listadd = new ew_Form("fgpa_listadd");

// Validate form
fgpa_listadd.Validate = function() {
...
fgpa_listadd.Form_CustomValidate = 
...
fgpa_listadd.ValidateRequired = true;
<?php } else { ?>
fgpa_listadd.ValidateRequired = false; 
<?php } ?>
...
<?php $gpa_list_add->ShowPageHeader(); ?>
<?php
$gpa_list_add->ShowMessage();
?>
<form name="fgpa_listadd" id="fgpa_listadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="gpa_list">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_gpa_listadd" class="table table-bordered table-striped">
