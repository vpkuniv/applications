...
<?php if ($users->_userID->Visible) { // userID ?>
		<td><span id="elh_users__userID" class="users__userID"><?php echo $users->_userID->FldCaption() ?></span></td>
<?php } ?>
<?php if ($users->User_Level->Visible) { // User Level ?>
		<td><span id="elh_users_User_Level" class="users_User_Level"><?php echo $users->User_Level->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $users_delete->RowCnt ?>_users__userID" class="control-group users__userID">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_User_Level" class="control-group users_User_Level">
